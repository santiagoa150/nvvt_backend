...
class ReportlabReceiptGenerator(ReceiptGenerator):
    ...
    async def create_client_receipt(
        ...
        cliente_table = Table(
            cliente_data, colWidths=[0.15 * available_width, 0.85 * available_width]
        )
        ...
        if out_of_stock_orders is not None:
            ...
            no_stock_products_title_table.setStyle(
                TableStyle(
                    [
            ...
            no_stock_products_table.setStyle(
                TableStyle(
                    [
        ...
        active_products_title_table.setStyle(
            TableStyle(
                [
                    ("BACKGROUND", (0, 0), (-1, 0), self._custom_colors["primary"]),
                ]
        ...
        active_products_table.setStyle(
            TableStyle(
                [
                    ("ROWBACKGROUNDS", (0, 0), (-1, -1), [colors.white, colors.lightgrey]),
                    ("VALIGN", (0, 0), (-1, -1), "MIDDLE"),
