...
class CqrsException(CommonException):
    ...
    def query_not_registered(query_type: str) -> "CqrsException":
        ...
        return CqrsException(
            CommonExceptionMessages.QUERY_NOT_REGISTERED.format(query_type=query_type)
        )
    ...
    def invalid_command_sub_class(command: str) -> "CqrsException":
        ...
        return CqrsException(
            CommonExceptionMessages.INVALID_COMMAND_SUB_CLASS.format(command=command)
        )
    ...
    def command_not_registered(command_type: str) -> "CqrsException":
        ...
        return CqrsException(
            CommonExceptionMessages.COMMAND_NOT_REGISTERED.format(command_type=command_type)
        )
